...
const initialNodes = [
  ...
  { id: 'v101b', type: 'custom', position: { x: 250, y: 50 }, parentId: 'b1', extent: 'parent', data: { title: 'Solid Hopper', subtitle: 'Pyrmetazole', hoverDetails: '<b>Tag:</b> V-101B<br/><b>Details:</b> 6.2 kg Pyrmetazole<br/>Rotary Airlock', typeClass: 'node-input' } },
  { id: 'amine_in', type: 'custom', position: { x: 450, y: 50 }, parentId: 'b1', extent: 'parent', data: { title: 'Base Supply', subtitle: 'Amine', hoverDetails: '<b>Details:</b> DIPEA (or TEA) added to stabilize Ti-complex and buffer pH', typeClass: 'node-input' } },
  ...
  { id: 'r101', type: 'custom', position: { x: 550, y: 400 }, parentId: 'b1', extent: 'parent', data: { title: 'Complexation STR', subtitle: 'Reactor', hoverDetails: '<b>Tag:</b> R-101<br/><b>Details:</b> Glass-Lined, VFD Agitator (M-101)<br/>Temp: 50-54°C, Time: 45-50 min', typeClass: 'node-unitOp' } },
